...
public class ConnectTask extends AsyncTask<Void, Void, Boolean> {
    ...
    ConnectTask(BluetoothDevice bluetoothDevice, BluetoothAdapter mBluetoothAdapter, ConnectedTask mConnectedTask, ArrayAdapter<String> mConversationArrayAdapter) {
    ...
    private void connected( BluetoothSocket socket) {
        MainActivity.mConnectedTask = new ConnectedTask(socket, mConnectedDeviceName, mConversationArrayAdapter);
